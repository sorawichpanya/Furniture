    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">15 Products</p>
                    <a href="workroom.php" class="cat-img position-relative overflow-hidden mb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="detail.php?p_id=<?php echo $data['p_id']; ?>&category=trendy" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    </div>
                </div>
            </div>
        <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-dark" href="editcus.php"><i class="fa fa-angle-right mr-2"></i>EditCustomer</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
